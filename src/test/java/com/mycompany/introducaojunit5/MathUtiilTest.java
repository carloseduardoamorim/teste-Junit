...
import static com.mycompany.introducaojunit5.MathUtiil.mdc;
...
class MathUtiilTest {
    ...
    void testMdcAParP1() {
        ...
        final int obtido = MathUtiil.mdc(a, b);
    ...
    void testMdcMParP4(){
        ...
        //mdc( 18,   6)  == 2 * mdc(9, 3)
        //      6       == 2 * 3 
        final int esperado = MathUtiil.mdc(a*m, b*m);
        final int obtido = m * MathUtiil.mdc(a, b);
        assertEquals(esperado, obtido);
    }
    ...
    void testMdcP6(){
        ...
        final int b =2;
        //mdc(a,b)==mdc(b,c)
        final int esperando = mdc(a, b);
        final int obtido = mdc(b, a);
        assertEquals(esperando, obtido);
    }
